...
{{--    @if(Route::has('livelogin'))--}}
{{--        <div class="absolute top-0 right-0 mt-4 mr-4 space-x-4 sm:mt-6 sm:mr-6 sm:space-x-6">--}}
{{--            @auth--}}
{{--                <a href="{{ url('/home/student') }}" class="no-underline hover:underline text-sm font-normal text-teal-800 uppercase">{{ __('Home') }}</a>--}}
{{--            @else--}}
{{--                <a href="{{ route('livelogin') }}" class="no-underline hover:underline text-sm font-normal text-teal-800 uppercase">{{ __('Login') }}</a>--}}
{{--                @if (Route::has('liveRegister'))--}}
{{--                    <a href="{{ route('liveRegister') }}" class="no-underline hover:underline text-sm font-normal text-teal-800 uppercase">{{ __('Register') }}</a>--}}
{{--                @endif--}}
{{--            @endauth--}}
{{--    @endif--}}
    <a href="{{ route('liveLogin') }}" class="no-underline hover:underline text-sm font-normal text-teal-800 uppercase">{{ __('Login') }}</a>
